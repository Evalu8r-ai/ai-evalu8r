            ...
            if cleanup:
                ...
                for project in shutdown_projects:
                    ...
                    table.add_row(
                        ...
                        f"[blue]evalu8r sandbox cleanup docker {project.name}[/blue]",
                    )
                print(table)
                print(
                    "\nCleanup all environments with: [blue]evalu8r sandbox cleanup docker[/blue]\n"
                )
...
async def cli_cleanup(project_name: str | None) -> None:
    # enumerate all evalu8r projects
