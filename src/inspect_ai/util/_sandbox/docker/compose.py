...
from evalu8r_ai.util._subprocess import ExecResult, subprocess

from .prereqs import (
    DOCKER_COMPOSE_REQUIRED_VERSION_PULL_POLICY,
    validate_docker_compose,
)
from .util import ComposeProject, is_evalu8rproject, sandbox_log
...
async def compose_ls() -> list[Project]:
    ...
    if result.success:
        ...
        projects = list(filter(lambda p: is_evalu8rproject(p["Name"]), projects))
