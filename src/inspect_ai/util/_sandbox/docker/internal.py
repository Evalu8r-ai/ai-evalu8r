...
from evalu8r_ai._util.display import display_type
from evalu8r_ai._util.error import PrerequisiteError
from evalu8r_ai.util._subprocess import subprocess

EVALU8R_WEB_BROWSER_IMAGE_DOCKERHUB = "evalu8r-web-browser-tool"

EVALU8R_WEB_BROWSER_IMAGE = "evalu8rweb_browser"

INTERNAL_IMAGES = {
    EVALU8R_WEB_BROWSER_IMAGE: PKG_PATH
    / "tool"
    / "_tools"
    / "_web_browser"
    / "_resources"
