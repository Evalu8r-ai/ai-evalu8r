...
SERVICES_DIR = "/tmp/evalu8r-sandbox-services"
...
class SandboxService:
    ...
    for calling back into the main Evalu8r process.
    ...
    ```python
    import sys
    sys.path.append("/tmp/evalu8r-sandbox-services/foo")
    import foo
    ```
    ...
    spec = importlib.util.spec_from_file_location(
        "foo", "/tmp/evalu8r-sandbox-services/foo/foo.py"
    )
