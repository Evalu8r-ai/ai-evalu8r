...
from evalu8r_ai._util._async import is_callable_coroutine
from evalu8r_ai._util.content import Content
from evalu8r_ai.util._store import Store, dict_jsonable, init_subtask_store
    ...
    def create_subtask_wrapper(func: Subtask, name: str | None = None) -> Subtask:
        ...
        async def run_subtask(*args: Any, **kwargs: Any) -> RT:
            ...
            if input is not None:
                ...
                log_input = {}
                if len(args) > 0:
                    params = list(evalu8r_ai.signature(func).parameters.keys())
