...
from evalu8r_ai.dataset._dataset import Sample
...
from evalu8r_ai.model._call_tools import tools_info
from evalu8r_ai.model._model import sample_total_tokens
from evalu8r_ai.tool import Tool, ToolChoice
from evalu8r_ai.tool._tool_def import ToolDef
from evalu8r_ai.util._store import Store, store_jsonable
...
class TaskState:
    ...
    def message_limit(self, messages: int | None) -> None:
        ...
        from evalu8r_ai.log._samples import set_active_sample_message_limit
    ...
    def token_limit(self, tokens: int | None) -> None:
        ...
        from evalu8r_ai.log._samples import set_active_sample_token_limit
    ...
    def completed(self) -> bool:
        ...
        # update messages
        from evalu8r_ai.log._samples import set_active_sample_total_messages
        from evalu8r_ai.log._transcript import SampleLimitEvent, transcript
