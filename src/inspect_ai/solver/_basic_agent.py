...
from evalu8r_ai.model._cache import CachePolicy
from evalu8r_ai.model._call_tools import call_tools
from evalu8r_ai.model._chat_message import ChatMessageTool, ChatMessageUser
from evalu8r_ai.model._model import get_model
from evalu8r_ai.scorer._metric import Score, ValueToFloat, value_to_float
from evalu8r_ai.scorer._score import score
from evalu8r_ai.solver._chain import chain
from evalu8r_ai.tool._tool import Tool, ToolResult, tool
        ...
        async def solve(state: TaskState, generate: Generate) -> TaskState:
            ...
            while not state.completed:
                ...
                if state.output.stop_reason == "model_length":
                    from evalu8r_ai.log._transcript import transcript
