...
from evalu8r_ai._display.core.textual import textual_enable_mouse_support
from evalu8r_ai._util.html import as_html_id
from evalu8r_ai.log._samples import active_samples
from evalu8r_ai.log._transcript import InputEvent, transcript
...
from .theme import evalu8rdark, evalu8rlight
...
class TaskScreenApp(App[TR]):
    ...
    def on_mount(self) -> None:
        ...
        self.register_theme(evalu8rdark)
        self.register_theme(evalu8rlight)
        self.theme = "evalu8r-dark"
