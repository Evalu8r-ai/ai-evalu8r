...
export const FindBand = ({ hideBand }) => {
  ...
  return html`<div
    style=${{
      ...
      marginRight: "20%",
      zIndex: "1060",
      color: "var(--evalu8r-find-foreground)",
      backgroundColor: "var(--evalu8r-find-background)",
      fontSize: "0.9rem",
      display: "grid",
  ...
  >
    <input
      ...
      margin: "0.1rem",
      outline: "none",
      border: "solid 1px var(--evalu8r-input-border)",
      color: "var(--evalu8r-input-foreground)",
      background: "var(--evalu8r-input-background)",
    }}
      placeholder="Find"
      onkeydown=${(e) => {
      if (e.key === "Escape") {
