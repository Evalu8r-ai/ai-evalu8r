...
from evalu8r_ai._util.content import Content, ContentImage, ContentText
from evalu8r_ai._util.text import truncate_string_to_bytes
from evalu8r_ai.model._trace import trace_tool_mesage
from evalu8r_ai.tool import Tool, ToolCall, ToolError, ToolInfo
from evalu8r_ai.tool._tool import (
    ToolApprovalError,
    ToolParsingError,
)
from evalu8r_ai.tool._tool_call import ToolCallContent, ToolCallError
from evalu8r_ai.tool._tool_def import ToolDef, tool_defs
from evalu8r_ai.tool._tool_info import parse_docstring
from evalu8r_ai.tool._tool_params import ToolParams
from evalu8r_ai.util import OutputLimitExceededError
...
async def call_tool(tools: list[ToolDef], message: str, call: ToolCall) -> Any:
    ...
    from evalu8r_ai.approval._apply import apply_tool_approval
...
def tool_params(input: dict[str, Any], func: Callable[..., Any]) -> dict[str, Any]:
    ...
    signature = evalu8r_ai.signature(func)
    type_hints = get_type_hints(func)
    docstring = evalu8r_ai.getdoc(func)
