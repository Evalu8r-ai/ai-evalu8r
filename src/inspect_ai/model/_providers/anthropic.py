...
from evalu8r_ai._util.constants import BASE_64_DATA_REMOVED, DEFAULT_MAX_RETRIES
from evalu8r_ai._util.content import Content, ContentText
from evalu8r_ai._util.error import exception_message
from evalu8r_ai._util.images import image_as_data_uri
from evalu8r_ai._util.logger import warn_once
from evalu8r_ai._util.url import data_uri_mime_type, data_uri_to_base64, is_data_uri
from evalu8r_ai.tool import ToolCall, ToolChoice, ToolFunction, ToolInfo
...
async def resolve_chat_input(
    ...
    # collapse user messages (as Evalu8r 'tool' messages become Claude 'user' messages)
