...
from evalu8r_ai._eval.task.util import task_file, task_run_dir
from evalu8r_ai._util.decorator import parse_decorators
from evalu8r_ai._util.error import PrerequisiteError
from evalu8r_ai._util.logger import warn_once
from evalu8r_ai._util.path import chdir_python
...
from evalu8r_ai.model import Model, ModelName
from evalu8r_ai.solver._solver import Solver, SolverSpec
from evalu8r_ai.util import SandboxEnvironmentSpec, SandboxEnvironmentType
from evalu8r_ai.util._sandbox.environment import resolve_sandbox_environment
...
def load_module(
    ...
    if module_path.suffix == ".py":
        ...
        try:
            from evalu8r_ai._util.notebook import NotebookLoader
        except ImportError:
            return None
