...
from evalu8r_ai._cli.util import parse_cli_args
from evalu8r_ai._display.core.active import display
from evalu8r_ai._util.config import resolve_args
from evalu8r_ai._util.constants import DEFAULT_LOG_FORMAT
from evalu8r_ai._util.error import PrerequisiteError
from evalu8r_ai._util.file import absolute_file_path
from evalu8r_ai._util.platform import platform_init
from evalu8r_ai._util.registry import registry_lookup
from evalu8r_ai.approval._apply import init_tool_approval
from evalu8r_ai.approval._policy import (
    ApprovalPolicy,
    ApprovalPolicyConfig,
    approval_policies_from_config,
    config_from_approval_policies,
)
from evalu8r_ai.log import EvalConfig, EvalLog, EvalLogInfo
from evalu8r_ai.log._file import read_eval_log_async
from evalu8r_ai.log._recorders import create_recorder_for_format
from evalu8r_ai.model import (
    GenerateConfig,
    GenerateConfigArgs,
    Model,
)
from evalu8r_ai.model._model import init_active_model, resolve_models
from evalu8r_ai.scorer._reducer import reducer_log_names
from evalu8r_ai.solver._chain import chain
from evalu8r_ai.solver._solver import Solver, SolverSpec
from evalu8r_ai.util import SandboxEnvironmentType
from evalu8r_ai.util._trace import init_trace
    ...
    **kwargs: Unpack[GenerateConfigArgs],
    ...
    Args:
        ...
        model (str | Model | list[str] | list[Model] | None): Model(s) for
            evaluation. If not specified use the value of the EVALU8R_EVAL_MODEL
    ...
    **kwargs: Unpack[GenerateConfigArgs],
    ...
    try:
        ...
        if len(resolved_tasks) == 0:
            log.warning("No evalu8r tasks were found at the specified paths.")
            return []
        ...
        # resolve recorder
        log_dir = log_dir if log_dir else os.environ.get("EVALU8R_LOG_DIR", "./logs")
...
def eval_init(
    ...
    **kwargs: Unpack[GenerateConfigArgs],
    ...
    if len(model_args) == 0:
        env_model_args = os.environ.get("EVALU8R_EVAL_MODEL_ARGS", None)
        if env_model_args:
