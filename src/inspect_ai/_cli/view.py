...
from evalu8r_ai._util.constants import DEFAULT_SERVER_HOST, DEFAULT_VIEW_PORT
from evalu8r_ai._view.view import view
...
def start(
    ...
    **common: Unpack[CommonOptions],
    ...
    EVALU8R_VIEW_AUTHORIZATION_TOKEN = "EVALU8R_VIEW_AUTHORIZATION_TOKEN"
    authorization = os.environ.get(EVALU8R_VIEW_AUTHORIZATION_TOKEN, None)
    if authorization:
        del os.environ[EVALU8R_VIEW_AUTHORIZATION_TOKEN]
        os.unsetenv(EVALU8R_VIEW_AUTHORIZATION_TOKEN)
