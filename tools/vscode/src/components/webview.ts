...
export class Evalu8rWebviewManager<T extends Evalu8rWebview<S>, S> {
  constructor(
  ...
  private createWebview(
    ...
    const evalu8rWebView = new this.webviewType_(context, this.server_, state, previewPanel);
    return evalu8rWebView;
  }
...
export abstract class Evalu8rWebview<T> extends Disposable {
  ...
  public constructor(
    ...
    private readonly _server: Evalu8rViewServer,
    state: T,
    webviewPanel: HostWebviewPanel
  ) {
    super();
