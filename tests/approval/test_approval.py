...
from evalu8r_ai.approval import ApprovalDecision, ApprovalPolicy, auto_approver
from evalu8r_ai.dataset import Sample
from evalu8r_ai.log._log import EvalLog
from evalu8r_ai.log._transcript import ApprovalEvent, ToolEvent
...
def test_approve_modify():
    ...
    event = check_approval(
        "modify.yaml",
        decision="modify",
        approver="evalu8rpackage/renamer",
    )
