...
from evalu8r_ai import Task, eval, task
from evalu8r_ai.dataset import Sample
from evalu8r_ai.model import ChatMessage, ModelName, ModelOutput
from evalu8r_ai.scorer import match
from evalu8r_ai.solver import Generate, TaskState, generate, solver
...
def ensure_test_package_installed():
    try:
        import evalu8rpackage  # type: ignore # noqa: F401
    except ImportError:
