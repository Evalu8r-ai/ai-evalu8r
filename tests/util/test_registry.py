...
from evalu8r_ai.scorer import Metric, Score, metric
from evalu8r_ai.solver import Plan, Solver, solver, use_tools
from evalu8r_ai.tool import Tool, bash
...
def test_registry_namespaces() -> None:
    ...
    # confirm that evalu8r_ai builtins have their namespace auto-appended
