...
from evalu8r_ai.scorer import Score, Scorer, Target, accuracy, includes, scorer
from evalu8r_ai.scorer._scorer import scorer_create
...
def test_score_package_name():
    ...
    from evalu8rpackage import simple_score
